      ...
      <div className="container-custom py-12 relative z-10">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} vice.city -  independent fan site and is not affiliated with Rockstar Games, Take-Two Interactive, or their subsidiaries. All trademarks and content belong to their respective owners.
          </p>
